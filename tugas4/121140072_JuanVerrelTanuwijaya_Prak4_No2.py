    ...
    def lakukan_aksi(self,other):
        if self.nama=="Antares":
            ...
            if self==robotmu:
                ...
                print(f"Robot lawan ({robotmu.nama}) menyerang sebanyak {damage} DMG")
            ...
            if self.jumlah_turn%2==0:
                ...
                if self==robotmu:
                    ...
                    print(f"Robot lawan ({robotmu.nama}) menambah darah sebanyak 4000 HP")
            other.terima_aksi(damage)
            if self==robotmu:
                print(f"Robotmu ({robotmu.nama}) menyerang sebanyak {damage} DMG")
            elif self==robotlawan:
            ...
            if self.jumlah_turn%4==0:
                ...
                if self==robotmu:
                    ...
                    print(f"Robot lawan ({robotmu.nama}) menambah darah sebanyak 7000 HP")
            other.terima_aksi(damage)
            if self==robotmu:
                print(f"Robotmu ({robotmu.nama}) menyerang sebanyak {damage} DMG")
            elif self==robotlawan:
...
class Lecalicus(Robot):
    def __init__(self, nama="Antares", health=45000, damage=5500):
        super().__init__(nama,health,damage)
...
while(robotmu.health>0 and robotlawan.health>0):
    ...
    if robotmu.health<=0:
        print(f"Robotmu ({robotmu.nama}) dikalahkan oleh robot lawan ({robotlawan.nama})!")
    if robotlawan.health<=0:
        print(f"Robotmu ({robotmu.nama}) mengalahkan robot lawan ({robotlawan.nama})!")
    print()
